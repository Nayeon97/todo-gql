...
export const NewTodoFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "NewTodo" },
      typeCondition: {
        kind: "NamedType",
...
} as unknown as DocumentNode<NewTodoFragment, unknown>;
